...
def create_region(regions, i, nRegion):
    ...
    r = Region()
    r.vector = config_region.get("vector")
    r.overwrite = True
...
#Partie superieure du jeu de donnees
    ...
    Module(
        ...
        output = "D:\\Documents\\MISSIONS\\interpolation_raster\\output\\" + str(nRegion) + "_output.tif",
...
if __name__ == "__main__":
    ...
    if(valuesOk):
        ...
        p = Process(target=create_region, args=(regions, 0, 0))
        p.start()
